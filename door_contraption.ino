...
const unsigned char scrollText[] PROGMEM ={" SORRY, I'M NOT AVAILABLE !! "};
const unsigned char scrollText2[] PROGMEM ={" COME IN !! "};
 
void setup()
{
  Serial.begin(9600);
  pinMode(red, OUTPUT); //set the LED pin as OUTPUT
